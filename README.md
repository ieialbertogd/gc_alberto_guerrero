...
6. It's necessary to upload a txt file with the matrix (in the root of the project, a test file named sample1.txt was placed for testing purposes. Feel free to modify it as you wish.)
